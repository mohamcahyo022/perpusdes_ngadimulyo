                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="editModalLabel{{ $buku->id }}">
                                                                Edit Data Buku</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('buku.fisik.update', $buku->id) }}"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="penulis_buku" name="penulis_buku"
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="nomor_buku" name="nomor_buku"
                                                                        value="{{ $buku->nomor_buku }}" required>
                                                                </div>
                                                                <div class="form-group">
